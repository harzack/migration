...
/*
	...
	Last revision: October 24th, 2018
*/

/* 
Description of the program:
open the source files, created from SQL query exports and already formated as JSON data:
- ITPMO_extract_xxx.json contains all EKME metadata extracted from the database for all documents and their versions we need to import.
	structure:
...
//   - ITPMO_extract_xxx: contains the list of all documents and versions we need to import
...
var JSONSourceFileName = "./../source/ITPMO_extract_" + iterationRun + ".json";
...
var DestinationFileName = "./destination/oiITPMO_001_" + iterationRun + ".xml";
...
// then the error file:
var ErrorFileName = "./destination/fileNotFound_" + iterationRun + ".txt";
